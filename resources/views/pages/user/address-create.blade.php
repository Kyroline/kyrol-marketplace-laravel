    ...
    <div class="card-body pt-0">
        <form action="{{ route('user.address.store') }}" method="POST">
            ...
            <div class="form-group">
                <input class="form-control" id="label" name="label" type="text" placeholder="Label" onfocus="focused(this)" onfocusout="defocused(this)">
            </div>
            <label class="form-label">Receiver Name</label>
            <div class="form-group">
                <input class="form-control" name="receiver" id ="receiver" type="text" placeholder="Name" onfocus="focused(this)" onfocusout="defocused(this)">
            </div>
