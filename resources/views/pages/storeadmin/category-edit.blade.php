        ...
        <div class="col-12">
            <div class="card" id="password">
                ...
                <div class="card-body pt-0">
                    <form action="{{ route('store.category.update', $category->category_id) }}" method="POST">
                        @csrf
                        <label class="form-label">Name</label>
                        <div class="form-group">
                            <input class="form-control" value="{{$category->category_name}}" id="name" name="name" type="text" placeholder="Category" onfocus="focused(this)" onfocusout="defocused(this)">
                        </div>
