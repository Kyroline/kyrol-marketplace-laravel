@extends('layouts.admin-layout', ['title' => 'Kyroshopu | Add Product'])
            ...
            <div class="col-lg-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <img class="w-100 border-radius-lg shadow-lg mt-3" id="avatar" src="https://raw.githubusercontent.com/creativetimofficial/public-assets/master/argon-dashboard-pro/assets/img/product-page.jpg" alt="product_image">
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-7">
                                <label>Name</label>
                                <input class="form-control" name="product_name" type="text" value="Minimal Bar Stool" onfocus="focused(this)" onfocusout="defocused(this)">
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-3">
                                ...
                                <input class="form-control" type="number" name="weight[]" onfocus="focused(this)" onfocusout="defocused(this)">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-3">
                                <label>Price</label>
                                <input class="form-control" type="number" name="price[]" onfocus="focused(this)" onfocusout="defocused(this)">
                            </div>
                            <div class="col-4">
                                <label>Stock</label>
                                <input class="form-control" type="number" name="stock[]" onfocus="focused(this)" onfocusout="defocused(this)">
                            </div>
                            <div class="col-5">
                                <label>SKU</label>
                                <input class="form-control" type="text" name="sku[]" onfocus="focused(this)" onfocusout="defocused(this)">
                            </div>
                        </div>
                        <div id="variants">
